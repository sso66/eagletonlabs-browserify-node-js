 ...
 * faster and supports broadcast and multicast. Because of these properties, UDP 
 * should be an excellent protocol to use for any system that must emit its 
 * state to multiple subscribers. Examples of these systems are online game 
 * engines that must share state between clients, distributed systems where 
 * components must be discoverable, and a blockchain network.
 * 
 */
const PORT = 20000;
...
// appropriate multicast address space. Much of the space is reserved, but you 
// can still find some unassigned ad-hoc space such as 
