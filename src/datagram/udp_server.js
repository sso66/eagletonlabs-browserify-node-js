 ...
 * server.
 * The listening event is fired, when the server has initialized and all ready to 
 * receive UDP packets. dgram.createSocket() can either accept 'udp4' or 'udp6'. 
 * The former uses IPv4, the later uses IPv6.
 * 
 */
var PORT = 33333;
var HOST = '127.0.0.1';
